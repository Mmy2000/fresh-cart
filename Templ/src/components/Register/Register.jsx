...
export default function Register() {
  ...
  {formik.errors.name && formik.touched.name ?<div class="p-4 mb-2 text-sm text-red-800 rounded-lg bg-red-50 font-medium dark:bg-gray-800 dark:text-red-400" role="alert">
  {formik.errors.name}
</div>:null}
  ...
  {formik.errors.email && formik.touched.email?<div class="p-4 mb-2 text-sm text-red-800 rounded-lg bg-red-50 font-medium dark:bg-gray-800 dark:text-red-400" role="alert">
  {formik.errors.email}
</div>:null}
  <div className="relative z-0 w-full mb-5 group">
  ...
  {formik.errors.phone && formik.touched.phone?<div class="p-4 mb-2 text-sm text-red-800 rounded-lg bg-red-50 font-medium dark:bg-gray-800 dark:text-red-400" role="alert">
  {formik.errors.phone}
</div>:null}
  <div className="relative z-0 w-full mb-5 group">
  ...
  <button  type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
      ...
      <p className='pl-4'>have an account ? <span className='font-semibold '><Link className='text-green-800  hover:text-green-700' to={'/login'}>Login now</Link></span> </p>
  </div>
