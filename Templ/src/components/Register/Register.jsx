...
export default function Register() {
  ...
  {formik.errors.name && formik.touched.name ?<div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 font-medium dark:bg-gray-800 dark:text-red-400" role="alert">
  {formik.errors.name}
</div>:null}
  ...
  {formik.errors.email && formik.touched.email?<div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 font-medium dark:bg-gray-800 dark:text-red-400" role="alert">
  {formik.errors.email}
</div>:null}
  <div className="relative z-0 w-full mb-5 group">
